...
# *****COMBINED EFFORTS BY- AARUSHI JAIN AND VANSHIKA ALANG*****
...
electronics1={1:30000,2:45000,3:25000,4:10000,5:5000,6:15000,7:12000,8:3000,9:15000,10:30000,11:60000,12:50000,16:10000,17:600,18:300}
...
def main():
    ...
    while x==True:
        print("\nDifferent Variety Of Products Available:")
        print("1.Clothing")
        print("2.Furniture")
        print("3.Groceries")
        print("4.Electronics")
        ...
        if choice1==2:
            ...
            while x==True:
                ...
                print("Items available in furniture section")
                print("1.Chairs")
                print("2.Tables")
                print("3.Couch")
                ...
                if(Ch==1):
                       while x==True:
                           print("Types of chairs available")
                ...
                if(Ch==2):
                       while x==True:
                           print("Types of tables available in store ")
                ...
                if(Ch==3):
                       while x==True:
                           print("Types of sofas( sofa fabrics) sets available in store ")
                ...
                if(Ch==4):
                       while x==True:
                           print("Types of ironing boards available in store ")
                ...
                if(Ch==5):
                       while x==True:
                           print("Types of wardrobes available in store ")
                ...
                if(Ch==6):
                       while x==True:
                           print("Types of desks available in store ")
                           print("1.Office Desk")
                ...
                if(Ch==7):
                       ...
                       while x==True:
                           print("Available colours for wooden grandfather clock")
                           print("1.Black")
                           print("2.Brown")
                ...
                if(Ch==8):
                       while x==True:
                           print("Available colours for drawer chest in store ")
                           print("1.White")
                           print("2.Brown")
                           print("3.Black")
                           print("4.Cream")
        ...
        if choice1==3:
            root=Tk()
            root.title("Welcome T Groceries Section")
            root.geometry("4000x4000")
            root.configure(bg="black")
        ...
        if choice1==4:
            ...
            while x==True:
                print('*'*32, "WELCOME TO ELECTRONICS SECTION", "*"*35)
                print("Items Available")
                print("1.Television")
...
if(ch==1):
    ...
    print("30% of the total amount needs to be paid at the time of purchase and rest of the amount through installments.")
    amt=d*0.3
